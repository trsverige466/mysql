...
/* ----------------------------------------------------------------------------
 ...
 -- aggregate fonksiyonlari ile ilgili bir kosul koymak icin group bydan sonra having cumlecigi kullanilir
 ...
 from manav
 group by urun_adi
 having maks!=max(urun_miktari) -- != yerine <> kullanilabilir
 order by maks;
 -- siralama group by , having , order by seklinde olur
 /*============================= DISTINCT =====================================
...
-----------------------------------------------------------------------------*/
select count(distincturun_adi) from manav;
